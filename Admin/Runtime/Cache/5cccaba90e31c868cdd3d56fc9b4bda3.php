          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form  action="__APP__/Info/add" method="post">
                ...
                <br/>
                <textarea type="textarea" name="content"  class="form-control" placeholder="content" required ></textarea>
                <br/>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="__APP__/Info/changeInfo" method="post">
                ...
                <br/>
                <input type="text" name="title" id="title5" class="form-control" placeholder="title" required autofocus>
                <br/>
                <textarea type="textarea" name="content" id="content5" class="form-control" placeholder="content" required ></textarea>
                <br/>
